    ...
    return (
        ...
        .encode(
            ...
            tooltip=[
                ...
                alt.Tooltip("comments_per_post:Q", title="게시물당 댓글", format=".1f"),
                alt.Tooltip("total_recommendations:Q", title="총 추천", format=",d"),
                alt.Tooltip("recommendations_per_post:Q", title="게시물당 추천", format=".1f"),
                alt.Tooltip("total_views:Q", title="총 조회", format=",d"),
                alt.Tooltip("views_per_post:Q", title="게시물당 조회", format=".1f"),
                alt.Tooltip("analysis_period:N", title="적용 기간"),
            ],
        )
